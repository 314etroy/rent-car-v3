...
@section('page_title')
    {{ __('translations.translate_login') }}
@endsection
...
@section('content')
    ...
    <h1 class="mb-5 mt-2 text-center uppercase">Accesează contul Starent</h1>
        ...
        {{-- <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    ...
                    name="remember">
                <span
                    class="ms-2 text-sm text-gray-600 dark:text-gray-400">{{ __('translations.translate_rememberMe') }}</span>
            </label>
        </div> --}}

        <div class="flex items-center justify-between mt-4">
            <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                    href="{{ route('register') }}">Nu ai cont?</a>
                    <div>
