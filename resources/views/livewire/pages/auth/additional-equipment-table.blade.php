@props([
    'emitToPath' => 'components.additional-equipment-modal',
    'emitToMethod' => 'show',
])

<section>
    <div class="w-full text-center p-1">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 pt-6">Date Echipamente</h1>
    </div>
    <div class="relative">
        <div
            ...
            <div>
                @include('common.generic-btn', [
                    ...
                    'wire_method' => handleEmitTo(
                        $emitToPath,
                        $emitToMethod,
                        handleModalAddData('add', $additionalEquipment->items())),
                    'class' =>
                        ...
                        <td class="px-6 py-4 flex justify-center">
                            ...
                            @include('common.generic-btn', [
                                ...
                                'wire_method' => handleEmitTo(
                                    $emitToPath,
                                    $emitToMethod,
                                    handleModalData(handleLivewireTableIds($index - 1, $additionalEquipment),
                                        'edit',
