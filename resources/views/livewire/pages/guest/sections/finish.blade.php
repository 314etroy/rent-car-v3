            ...
            <div class="container relative">
                <div class="text-center">
                    <div class="px-10 py-72 my-7">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900">Vei fi redirecționat către pagina de plată...</h1>
                       <p>
                        <form name="frmPaymentRedirect" method="get" action="{{$ruta}}">
                        </form>
