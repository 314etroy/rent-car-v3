@props([
    'inputs' => [
        ...
        [
            'type' => 'text',
            'key' => 'Descriere 1',
            'placeholder' => 'Adaugă Descriere 1',
        ...
        [
            'type' => 'text',
            'key' => 'Descriere 2',
            'placeholder' => 'Adaugă Descriere 2',
                    ...
                    @case('edit')
                        <div class="w-full">
                            @include('common.genericInputFields', [
                                'type' => 'checkbox',
                                'key' => 'Display',
                                'labelText' => 'Se afișează pentru utilizatori',
