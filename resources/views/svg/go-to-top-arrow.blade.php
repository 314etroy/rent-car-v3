<svg fill="{{ $fill ?? '' }}" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    fill="#000000" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 330 330" xml:space="preserve"
    class="{{ $class ?? '' }}">
