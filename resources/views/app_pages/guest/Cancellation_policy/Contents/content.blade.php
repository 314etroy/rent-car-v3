<div class="text-white">
    <div class="content">
        ...
        <p>Autoturismul va fi livrat la locația și la ora convenite în momentul rezervării, într-o stare de
            funcționare corespunzătoare, curat, iar acest aspect va fi menționat în procesul verbal. Returnarea
        ...
        <p>
            Părăsirea teritoriului românesc cu autoturisme închiriate este posibilă numai cu acordul scris al
            Starent Închirieri Auto, în anumite condiții. Poate fi impusă o limită zilnică de kilometri, iar
            depășirea acesteia va fi taxată cu 1 leu/km.
        </p>
        <p>&nbsp;</p>
        <p>
            ...
            tehnice sau evenimente rutiere pe parcursul contractului de închiriere.
        </p>
        <p>&nbsp;</p>

        <p>Este interzis fumatul în autoturismele Starent Închirieri Auto. Încălcarea acestei reguli atrage o taxă
            de 250 lei.</p>

        <p>&nbsp;</p>

        <p>Se aplică o taxă de administrare de 250 lei pentru gestionarea oricăror daune sau amenzi survenite în
            perioada de închiriere. Amenzile de circulație vor fi achitate în totalitate de conducătorul auto.</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <h1 class="title">Politica privind garanția și opțiunile aferente
        </h1>
        ...
        <p>&nbsp;</p>
        <h1 class="title">Condiii neacoperite de Asigurare</h1>
        <p>&nbsp;</p>

        <ul>
            <li>Pagube intenționate sau rezultate din neglijența clientului.</li>
            <li>Pagube cauzate de incendii, explozii etc., provocate de client.</li>
            <li>Neîndeplinirea măsurilor de limitare a pagubelor de către client.</li>
            <li>Conducerea autoturismului de către o persoană neautorizată.</li>
            <li>Pagubele cauzate cauciucurilor, jenților sau subansamblelor autoturismului.</li>
            <li>Conducerea sub influența alcoolului sau a altor substanțe.</li>
            <li>Părăsirea teritoriului României fără acordul Starent Închirieri Auto.</li>
            <li>Neprezentarea documentelor de la poliție în caz de accident/pagubă/furt.</li>
            <li>Pagube cauzate de nerespectarea normelor de încărcare și ancorare a autoturismului.</li>
            <li>Pagubele produse în timpul tractării, remorcării sau transportării autoturismului.</li>
            <li>Situații în care autoturismul a fost lăsat deschis sau cheia a fost lăsată în contact.</li>
        </ul>

        <p>În toate aceste cazuri, clientul va fi responsabil pentru contravaloarea integrală a daunelor</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>

        <h1 class="title">Accidente sau avarii</h1>
        <p>&nbsp;</p>
        <p>În caz de accident sau daune, clientul este obligat:
        </p>

        <ul>
            <li>să limiteze pagubele</li>
            <li>să anunțe autoritățile competente și să solicite documentele legale;</li>
