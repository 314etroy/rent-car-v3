<section id="portfolio" class="section-Portfolio 2xl:py-[80px] py-[70px]">
    <div class="banner text-center mb-[30px]" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
        <span class="text-[14px] text-[#000]">Portofoliu de masini</span>
        <h2
            class="text-center mt-[5px] text-black 2xl:text-[35px] xl:text-[33px] lg:text-[30px] md:text-[26px] sm:text-[24px] text-[22px] font-bold">
            Ce mașini puteți<span class="text-[#7963e0]"> închiria de la noi</span> </h2>
    </div>
    <div
        ...
        <a href="{{route("reserve_now")}}" class="link-to" style="margin:50px auto">
